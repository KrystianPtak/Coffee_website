...
function renderFooterContainer() {
			...
			<section class="contact">
				<div class="contact__body container">
					<a href="#" class="contact__logo"
						>Coffee<img src="img/logo.png" alt="" class="contact__img"
					/></a>
  ...
  <div class="footer__body container">
				<p>
					All rights reserved ©Coffee <span class="footer__date"></span>
				</p>
				<div class="footer__imgs">
					<i class="fa-brands fa-facebook footer__img"></i>
					<i class="fa-brands fa-instagram footer__img"></i>
					<i class="fa-brands fa-twitter footer__img"></i>
				</div>
			</div>
      </footer>
      `;
